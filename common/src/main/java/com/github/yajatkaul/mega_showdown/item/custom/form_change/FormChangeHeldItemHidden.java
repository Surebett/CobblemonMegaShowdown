...
public class FormChangeHeldItemHidden extends ToolTipItem {
    ...
    public FormChangeHeldItemHidden(Properties properties, String revertAspect, String applyAspect, List<String> pokemons, String effectId, boolean tradable, @Nullable Consumer<Pokemon> onApplyCallback, @Nullable Consumer<Pokemon> onRevertCallback) {
        super(properties);
